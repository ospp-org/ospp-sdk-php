...
final class EnvelopeSerializationTest extends TestCase
{
    ...
    public function heartbeat_response_json_snapshot(): void
    {
        ...
        $expectedJson = '{"messageId":"msg_660e8400-e29b-41d4-a716-446655440001","messageType":"RESPONSE","action":"Heartbeat","timestamp":"2025-02-20T12:00:00.000Z","source":"server","protocolVersion":"1.0.0","payload":{"currentTime":"2025-02-20T12:00:00.000Z"}}';
    ...
    public function start_service_request_with_mac_snapshot(): void
    {
        ...
        $expectedJson = '{"messageId":"cmd_770e8400-e29b-41d4-a716-446655440002","messageType":"REQUEST","action":"StartService","timestamp":"2025-03-01T08:15:30.250Z","source":"server","protocolVersion":"1.0.0","payload":{"stationId":"ST-001","bayId":"BAY-01"},"mac":"dGVzdC1tYWMtdmFsdWU="}';
    ...
    public function event_message_json_snapshot(): void
    {
        ...
        $expectedJson = '{"messageId":"msg_880e8400-e29b-41d4-a716-446655440003","messageType":"EVENT","action":"StatusNotification","timestamp":"2025-04-10T16:45:00.999Z","source":"server","protocolVersion":"1.0.0","payload":{"stationId":"ST-002","bayId":"BAY-03","status":"available"}}';
